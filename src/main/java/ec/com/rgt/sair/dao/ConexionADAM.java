...
public class ConexionADAM
{
    ...
    public static void updateUsuarios() {
        ...
        //luisana
        List c = dao.find(" from SairParametros where nombre = 'MIGRACION_SAIR'");
        ...
        usuarios.add(new SairGerente(BigDecimal.valueOf(10003635), "ADRIANA SOLEDAD", "KESALAZA", null, BigDecimal.valueOf(34.1), "INGENIERO AMBIENTAL", "MEJIA SUAREZ", "A", "ADRIANA SOLEDAD MEJIA SUAREZ  ", BigDecimal.valueOf(81), "GUAYAS", "0916439409", null,null,null,"AMEJIAS@CLARO.COM.EC", null));
        usuarios.add(new SairGerente(BigDecimal.valueOf(10003636), "ADRIANA SOLEDAD", "DALAVA", null, BigDecimal.valueOf(2.7), "INGENIERO AMBIENTAL", "MEJIA SUAREZ", "A", "ADRIANA SOLEDAD MEJIA SUAREZ  ", BigDecimal.valueOf(959), "GUAYAS", "0915182281", null,null,null,"AMEJIAS@CLARO.COM.EC", null));
        usuarios.add(new SairGerente(BigDecimal.valueOf(10003636), "ADRIANA SOLEDAD", "DALAVA", null, BigDecimal.valueOf(2.7), "INGENIERO AMBIENTAL", "MEJIA SUAREZ", "A", "ADRIANA SOLEDAD MEJIA SUAREZ  ", BigDecimal.valueOf(959), "GUAYAS", "1704537560", null,null,null,"AMEJIAS@CLARO.COM.EC", null));
        ...
        if (banderaMigracion.equals("S")) {
            ...
            if (gerentes != null) {
                ...
                for (int i = 0; i < gerentes.length; ++i) {
                    ...
                    System.out.println("ID USUARIO A PROCESAR: " + adam.getCedula().toString() + " NAME: " + adam.getUsuario());
                    lis.add(adam.getCedula().toString());
                    System.out.println("CONSULTA SAIR_GERENTE POR USUARIO: " + adam.getCedula().toString());
                    
                    // Add try-catch block around the database query
                    try {
                    
                        final List<SairGerente> l = (List<SairGerente>) dao.find("from SairGerente a where a.cedula= '" + adam.getCedula()+"'");
                        ...
                        for (int j = 0; j < l.size(); ++j) {
                            ...
                            if (areasAdam.getCodigosf() == null) {
      
                                areasAdam.setCodigo_sf(adam.getIdGerente());
                                dao.saveOrUpdate((Object) areasAdam, (Class) areasAdam.getClass());
                                System.out.println("ACTUALIZO codigo sf alf usuario " + areasAdam.getCedula());
                            }
                        }
                    } catch (Exception e) {
        ...
        if (gerentes != null) {
            ...
            for (int i = 0; i < gerentes.length; ++i) {
                ...
                final List<SairGerente> l = (List<SairGerente>)dao.find("from SairGerente a where a.cedula= " + adam.getCedula());
                if (l.isEmpty()) {
                    System.out.println("NO EXISTE USUARIO EN SAIR_GERENTE " + adam.getCedula().toString());
                    System.out.println("SE CREA NUEVO USUARIO EN SAIR_GERENTE CON ESTADO 'A'");
                    adam.setEstado("A");
                    dao.saveOrUpdate((Object)adam, (Class)adam.getClass());
                    System.out.println("NUEVO U " + adam.getCedula());
                }
